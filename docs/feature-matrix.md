...
| **ChatGPT Apps / Connectors** | ~10분 | **Plus+ 필요** (Free엔 Google Calendar 커넥터 없음) / Business+ 조직 배포 | ❌ (2026-05-29 확정) | 비개발 다수 |
...
|---|---|---|---|---|
| 캘린더 읽기/쓰기 | ✅ 커넥터 | ⚠️ Plus+만 가능 (Free엔 Google Calendar 커넥터 자체가 없음, 2026-05-29 확정) | ✅ 커넥터/MCP | ✅ 커넥터 (검증됨) |
